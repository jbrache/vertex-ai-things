## Acknowledgements
*   Original source from Jesus Chavez [Jira MCP Server & Google ADK Agent](https://github.com/jchavezar/vertex-ai-samples/tree/main/gen_ai/adk/ge_adk_mcp_jira_cloudrun_server)
